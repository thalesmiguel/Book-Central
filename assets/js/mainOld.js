  ...
  //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    function adicionar_lote() {
        ...
        var tbody = $('#lotesbdados');
        var tr = $("<tr><td><input type='text'id='lote'class='form-control'></td>" +
        "<td><input type='text'id='vendedor'class='form-control'></td>" +
        "<td><input type='text'id='tot'class='form-control'></td>" +
        "<td><input type='text'id='subtot'class='form-control'></td>" +
        "<td><input type='text'id='qtde'class='form-control'></td>" +
        "<td><input type='text'id='captacoes'class='form-control'></td></tr>");
        
        tr.find('#lote')
        .attr('id', 'lote' + index);
        
        tr.find('#vendedor')
        .attr('id', 'vendedor' + index);
     ...
     function gravar_lote(campo, id, elemento) {
        ...
        json[id]['@attributes'][campo] = document.getElementById(elemento).value;;
        jsonfile.writeFile('./LOTE.json', json);
     };
  
  
     function carregar_lotes() {
         //Ler ou Criar arquivo LOTE.json
            var jsonfile = require('jsonfile');
            ...
            try {
                ...
                var objson = xml2json.fromFile('lote.xml');
                var json = objson.DATAPACKET.ROWDATA.ROW; 
                var obj = json;
            ...
            var table = document.getElementById('lotesbdados');
            ...
            json.forEach(function(element) {
                //   document.writeln(element['@attributes'].LOTE_VENDEDOR); 
                var tr = $("<tr><td><input type='text'id='lote'class='form-control' disabled=true></td>" +
                "<td><input type='text'id='vendedor'class='form-control' disabled=true></td>" +
                "<td><input type='text'id='tot'class='form-control'></td>" +
                "<td><input type='text'id='subtot'class='form-control'></td>" +
                "<td><input type='text'id='qtde'class='form-control'></td>" +
                "<td><input type='text'id='captacoes'class='form-control'></td></tr>");
                ...
                tr.find('#lote')
                .attr('id', 'lote' + element['@attributes'].LOTE_COD)
                .val(element['@attributes'].LOTE_COD);
                
                tr.find('#vendedor')
                .attr('id', 'vendedor' + element['@attributes'].LOTE_COD)
                .val(element['@attributes'].LOTE_VENDEDOR);
                
                element['@attributes'].LOTE_SEXO = element['@attributes'].LOTE_SEXO;
                tr.find('#tot')
                .attr('id', 'tot' + element['@attributes'].LOTE_COD)
                .attr('onkeyup', "gravar_lote('LOTE_SEXO', " + index + ", " + "'tot" + element['@attributes'].LOTE_COD + "')")
                .val(element['@attributes'].LOTE_SEXO + ' ' + element['@attributes'].LOTE_VENDEDOR);
                
                if (element['@attributes'].LOTE_SUBTOT == undefined) {
                    element['@attributes'].LOTE_SUBTOT = "";
                }
                tr.find('#subtot')
                .attr('id', 'subtot' + element['@attributes'].LOTE_COD)
                .attr('onkeyup', "gravar_lote('LOTE_SUBTOT', " + index + ", " + "'subtot" + element['@attributes'].LOTE_COD + "')")
                .val(element['@attributes'].LOTE_SUBTOT);
                
                tr.find('#qtde')
                .attr('id', 'qtde' + element['@attributes'].LOTE_COD)
                .attr('onkeyup', "gravar_lote('LOTE_QTDE', " + index + ", " + "'qtde" + element['@attributes'].LOTE_COD + "')")
                .val(element['@attributes'].LOTE_QTDE);
                
                tr.find('#captacoes')
                .attr('id', 'captacoes' + element['@attributes'].LOTE_COD)
                .attr('onkeyup', "gravar_lote('LOTE_CAPTACOES', " + index + ", " + "'captacoes" + element['@attributes'].LOTE_COD + "')")
                .val(element['@attributes'].LOTE_CAPTACOES);
...
$(function() {
  ...
  //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    $('#carregar-lotes').click(function (e) {
        
       carregar_lotes();

    });
    
    $('#adicionar-lote').click(function (e) {
